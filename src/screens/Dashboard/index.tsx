        ...
        <Container>
            <Header>
                <UserWrapper>
                    <UserInfo>
                        <Photo 
                            source={{ 
                                uri: 'https://avatars.githubusercontent.com/u/44904514?v=4https://avatars.githubusercontent.com/u/44904514?v=4'
                            }}/>
                        <User>
                            <UserGreeting>Olá,</UserGreeting>
                            <UserName>Lucas Bueno</UserName>
                        </User>
                    </UserInfo>
                    <Icon name="power"/>
                </UserWrapper>
            ...
            <Transactions>
                ...
                <TransactionList
                    ...
                    renderItem={({item}) => <TransactionCard data={item}/>}s
                />
